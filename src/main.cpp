...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 500000 blocks, which will occur approximately every 6 months
    nSubsidy >>= (nHeight / 500000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CannaCoin: 1 days
static const int64 nTargetSpacing = 30; // CannaCoin: 30 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9199519e6dc47c4571e518218edd80341407a86e4b2c3b9b42404490c29707d1");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Created Feb 14 2014. 15% will be pre-mined to support the development of the currency";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392267620;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085631489;
        ...
        assert(block.hashMerkleRoot == uint256("0xd0199c43e4a247ebeb2d773c30d3cdc84658584efe4baeb6f13beed33634f87c"));
